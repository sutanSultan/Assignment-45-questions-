...
var new_users = ['eric', 'ALICE', 'george', 'DAVID', 'frank'];
for (var _i = 0, new_users_1 = new_users; _i < new_users_1.length; _i++) {
    var new_user = new_users_1[_i];
    if (current_users.map(function (user) { return user.toLowerCase(); }).concat(new_user.toLowerCase())) {
        console.log("The username ".concat(new_user, " is already taken. Please choose a different username."));
    }
    else {
...
for (var _d = 0, animals_2 = animals; _d < animals_2.length; _d++) {
    var animal = animals_2[_d];
